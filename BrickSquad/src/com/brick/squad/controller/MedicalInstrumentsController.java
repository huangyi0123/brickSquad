...
public class MedicalInstrumentsController {
	...
	public String findOrderByMedicalInstruments(HttpServletRequest request,PageBeanUtil pageBean) throws Exception{
		...
		request.setAttribute("listArticle2", listArticle2);
		 ...
		 int limitPage=pageBean.getLimitPage();
		 pageBean=articleService.findOrderByMedicalInstruments(page, sequence,limitPage);
		List<Article> listArt=pageBean.getList();
		List<Article> listArticle4=yiLiaoUtile.findArticleImgAndName(request, listArt);
		pageBean.setList(listArticle4);
		if(sequence==3){
	...
	public String findOrderByMedicalInstrumentsDate(HttpServletRequest request,PageBeanUtil pageBean) throws Exception{
		...
		request.setAttribute("listArticle2", listArticle2);
		 ...
		 int sequence=pageBean.getSequence();
		 int limitPage=pageBean.getLimitPage();
		 pageBean=articleService.findOrderByMedicalInstrumentsDate(page, sequence,limitPage);
		List<Article> listArt=pageBean.getList();
		List<Article> listArticle4=yiLiaoUtile.findArticleImgAndName(request, listArt);
		pageBean.setList(listArticle4);
		request.setAttribute("url", "findOrderByMedicalInstrumentsDate");
	...
	public String findOrderByMedicalInstrumentsPop(HttpServletRequest request,PageBeanUtil pageBean) throws Exception{
		...
		request.setAttribute("listArticle2", listArticle2);
		 ...
		 int sequence=pageBean.getSequence();
		 int limitPage=pageBean.getLimitPage();
		 pageBean=articleService.findOrderByMedicalInstrumentsPop(page, sequence,limitPage);
		List<Article> listArt=pageBean.getList();
		List<Article> listArticle4=yiLiaoUtile.findArticleImgAndName(request, listArt);
		pageBean.setList(listArticle4);
