...
public class GuidanceController {
	...
	public String toAddGuidance(HttpServletRequest request, String id)
			throws Exception {
	...
	@ResponseBody
	public String getGuidanceList(int pSize, int cPage, String keyword)
			throws Exception {
	...
	public String findGuidanceById(HttpServletRequest request, String id)
			throws Exception {
		Guidance guidance = guidanceService.queryGuidanceById(id);
