...
public class OrderDetailsController {
	...
	public String toAddOrdersDetails(HttpServletRequest request, String id)
			throws Exception {
		if (id != null) {
	...
	public String updateOrdersDetails(OrderDetails orderDetails)
			throws Exception {
	...
	public String findOrdersDetailsById(HttpServletRequest request, String id)
			throws Exception {
		OrderDetails orderDetails = orderDetailsService
				.findOrderDetailsByIdName(id);
		request.setAttribute("orderDetails", orderDetails);
