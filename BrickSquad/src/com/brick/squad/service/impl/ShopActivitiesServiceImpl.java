...
public class ShopActivitiesServiceImpl implements ShopActivitiesService {
	...
	/*
	 * @Override public int findShopActivitiesAllCount() { // TODO
	 * Auto-generated method stub return
	 * shopActivitiesMapper.findShopActivitiesAllCount(); }
	 */

	@Override
	public String findAllShopActivities() {
		List<Select> selects = typeMapper
				.findTypeByParentId("9356093ab7eb11e78d4f5254002ec43c");
	...
	public String findTypeAndArticle() {
		...
		List<Select> type = typeMapper
				.findTypeByParentId("shangpinhuodongleixing");
	...
	public ShopActivitiesExpand findShopActivitiesAndTypeAndArticle(String id) {
		ShopActivitiesExpand shopActivitiesExpand = shopActivitiesMapper
