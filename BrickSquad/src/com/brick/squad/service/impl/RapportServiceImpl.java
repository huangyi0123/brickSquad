...
public class RapportServiceImpl implements RapportService {
	 ...
	 *//** 查询老人客户沟通总数 */
	/*
	 * public Integer findRapportCount() throws Exception { Integer
	 * countRapport=rapportMapper.findRapportCount(); return countRapport; }
	 */
	@Override
	/**老人客户沟通分页查询*/
	public String rapportPagination(Pagination pagination) throws Exception {
		List<RapportExpand> regions = rapportMapper
				.rapportPagination(pagination);
	...
	public RapportExpand findRapportAndUserAndPersonalInformation(String id)
			throws Exception {
		RapportExpand rapportExpand = rapportMapper
