...
public class ShopActivitiesServiceTest {
	...
	/*
	 * @Test public void testshopActivitiesPagination(){ List<ShopActivities>
	 * shopActivities = new ArrayList<>(); Pagination pagination = new
	 * Pagination(); pagination.setCurentPage(1); pagination.setPageSize(4);
	 * shopActivities=
	 * shopActivitiesService.shopActivitiesPagination(pagination); for
	 * (ShopActivities shopActivities2 : shopActivities) {
	 * System.out.println(shopActivities2.toString()); } }
	 */

	// 测试统计
	/*
	 * @Test public void findShopActivitiesAllCount(){
	 * 
	 * 
	...
	public void shopActivitiesPagination() {
		...
		String data = shopActivitiesService
	...
	public void findShopActivitiesAndTypeAndArticle() {
		ShopActivitiesExpand shopActivitiesExpand = shopActivitiesService
				.findShopActivitiesAndTypeAndArticle("12");
