...
a:HOVER {
  ...
  <div class="search">
		<div class="input-group" style="width: 520px;margin-left: 52px;">
			<input type="text" class="form-control" placeholder="可根据角色名搜索" id="keyword">
	...
	<div class="input-group"
		...
		<div class="input-group-btn" style="width:100px;">
			...
			<ul class="dropdown-menu">
				<li><a href="${pageContext.request.contextPath}/role/toAddRole"
					style="margin-left: 10px;"><i class="fa fa-plus"></i>
					<font style="margin-left: 10px;">添加</font></a></li>
				<!-- <li><a href="#">导出</a></li>
