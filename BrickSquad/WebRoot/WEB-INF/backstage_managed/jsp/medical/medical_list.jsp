...
<script type="text/javascript" src="resource/js/medical_list.js"></script>
...
<body>
	<div class="search">
		<div class="input-group" style="width: 520px;margin-left: 52px;">
			<input type="text" class="form-control" placeholder="可输入老人姓名、检查医院、检查类型、病历详情进行查询" id="keyword">
