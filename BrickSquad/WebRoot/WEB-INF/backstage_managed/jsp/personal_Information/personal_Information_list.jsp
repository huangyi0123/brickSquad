...
<script type="text/javascript"
	src="resource/js/personal_Information_list.js"></script>
<script type="text/javascript"
...
<body>
	<div class="search">
		<div class="input-group" style="width: 520px;margin-left: 52px;" >
			<input type="text" class="form-control" placeholder="可输入姓名、身份证号码进行查找" id="keyword" value="${keyword}">
			...
			<ul class="dropdown-menu">
				<li><a href="personalInformation/toAddPersonalInformation"
					style="margin-left: 10px;"><i class="fa fa-plus"></i><font
						style="margin-left: 10px;"> 完善老人信息 </font></a></li>
				<!-- <li><a href="#">导出</a></li>
