...
<body>
	...
	<form action="buyers/${url} " class="layui-form" method="post">
		...
		<div class="layui-form-item">
			...
			<c:if test="${url eq 'updateBuyersById'}">
			 <input type="hidden" name="buyers.id" value="${addressAndBuyersExpand.buyers.id}"> 
				...
				<select  lay-filter="perid"  id="perid"
				 <input type="hidden" name="buyers.id" value="${addressAndBuyersExpand.buyers.id}"> 
					val="${addressAndBuyersExpand.buyers.id}" name="buyers.id" lay-search="">
					<option value="">选择买家姓名</option>
				</select>
				</c:if>
			</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				 <select  id="jb" name="buyers.grade" lay-search="" val="${addressAndBuyersExpand.buyers.grade}"
					lay-filter="hyjb">
