...
<script type="text/javascript">
	$(function() {
		...
		init("",${limiterole.buyers.ad},${limiterole.buyers.dl},false);
		}
...
a:HOVER {
	...
	<div class="search">
		<div class="input-group" style="width: 520px;margin-left: 52px;">
			<input type="text" class="form-control" placeholder="可输入客户名称、登记进行查找" id="keyword">
