...
<script type="text/javascript"
	src="resource/js/business_list.js"></script>
<script type="text/javascript"
...
<script type="text/javascript">
	$(function() {
		...
		init("",!${limiterole.business.ad},!${limiterole.business.dl},false);
		}
...
<body>
	<div class="search">
		<div class="input-group" style="width: 520px;margin-left: 52px;">
			<input type="text" class="form-control" placeholder="可输入姓名、身份证信息、店铺名进行查找" id="keyword">
	...
	<div class="input-group"
		...
		<div class="input-group-btn" style="width:100px;">
			...
			<ul class="dropdown-menu">
				<li><a href="business/toAddBusiness" style="margin-left: 10px;"><i
