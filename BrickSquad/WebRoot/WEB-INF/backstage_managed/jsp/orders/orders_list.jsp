...
<script type="text/javascript"
	src="resource/js/orders_list.js"></script>
<script type="text/javascript"
...
<script type="text/javascript">
	$(function() {
		...
		init("",!${limiterole.orders.ad},!${limiterole.orders.dl},false);
		}
...
<body>
	<div class="search">
		<div class="input-group" style="width: 520px;margin-left: 52px;">
			<input type="text" class="form-control" placeholder="Search for..." id="keyword" value="${keyword}">
	...
	<div class="input-group"
		...
		<div class="input-group-btn" style="width:100px;">
			...
			<ul class="dropdown-menu">
				<li><a href="${pageContext.request.contextPath}/orders/toAddOrders" id="addOrders"
