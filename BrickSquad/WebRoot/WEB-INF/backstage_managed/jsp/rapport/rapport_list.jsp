...
<script type="text/javascript"
	src="resource/js/rapport_list.js"></script>
<script type="text/javascript"
...
<script type="text/javascript">
	$(function() {
		...
		init("",!${limiterole.rapport.ad},!${limiterole.rapport.dl},false);
		}
...
<body>
	<div class="search">
		<div class="input-group" style="width: 520px;margin-left: 52px;">
			<input type="text" class="form-control" placeholder="可输入老人姓名、沟通人姓名、沟通目标进行查找" id="keyword">
