...
<script type="text/javascript">
  ...
  <br>
	...
	<br>
   <form class="layui-form" action="relatives/${url}" id="form1" method="post">
   
   <input type="hidden" name="relatives.id" value="${relaAddressTypePerson.relatives.id }">
   <input type="hidden" name="address.id" value="${relaAddressTypePerson.address.id }">
   <input type="hidden" name="type.id" value="${relaAddressTypePerson.type.id }">
   <input type="hidden" name="personalInformation.id" value="${relaAddressTypePerson.personalInformation.id }">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="relatives.name" required lay-verify="required" 
				value="${relaAddressTypePerson.relatives.name}"
					placeholder="亲属姓名" autocomplete="off" class="layui-input">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="relatives.telephone" required lay-verify="required"
...
<!-- 显示地址表信息 -->
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select required lay-verify="required" val="${relaAddressTypePerson.address.provinceId}"
			...
			<div class="layui-input-inline">
				<select required lay-verify="required" val="${relaAddressTypePerson.address.cityId}"
			...
			<div class="layui-input-inline">
				<select required lay-verify="required" val="${relaAddressTypePerson.address.countyId}"
			...
			<div class="layui-input-inline">
				<select required lay-verify="required" val="${relaAddressTypePerson.address.countryId}"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select lay-filter="relationshipid" name="relatives.relationshipId" id="relationshipid"
