...
<script type="text/javascript" src="resource/js/healthRecords_list.js"></script>
...
<body>
	<div class="search">
		<div class="input-group" style="width: 520px;margin-left: 52px;">
			<input type="text" class="form-control" placeholder="可输入姓名、登记人进行查找" id="keyword">
	...
	<div class="input-group"
		...
		<div class="input-group-btn" style="width:100px;">
			...
			<ul class="dropdown-menu">
				<li><a href="healthRecords/toAddHealthRecords" id="addHealthRecords"
