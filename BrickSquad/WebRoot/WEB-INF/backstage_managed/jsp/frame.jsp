	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul style="margin-top: 10px;" class="nav" id="side-menu">
				...
				<c:if
					...
					<li><a class="J_menuItem"> <i class="fa fa-table"></i>
						...
						<ul class="nav nav-second-level">
							...
							<li><a class="J_menuItem" href="type/toType">类型列表</a></li>
						</ul></li>
				</c:if>
				<c:if
					...
					<li><a class="J_menuItem"> <i class="fa fa-table"></i>
							老人客户关系管理 <span class="fa arrow"></span>
					</a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="rapport/toRapportList">老人客户沟通列表</a></li>
							<li><a class="J_menuItem"
								href="onlineParticipationInfo/toOnlineParticipationInfoList">在线参与表</a></li>
							<li><a class="J_menuItem"
								href="reservation/toReservationList">预约表</a></li>
							</ul></li>
							<li><a class="J_menuItem"> <i class="fa fa-table"></i>
								...
								<ul class="nav nav-second-level">
									...
									<li><a class="J_menuItem" href="guidance/toGuidanceList">老人健康指导列表</a>
									</li>
								</ul></li>
				</c:if>
				<c:if
					...
					<li><a class="J_menuItem"> <i class="fa fa-table"></i>
						...
						<ul class="nav nav-second-level">
							...
							<c:if
								test="${user.roleId ne '9d2a23cac05511e7aca65254002ec43c' }">
								<li><a class="J_menuItem" href="business/toBusiness">商家信息管理列表</a>
								</li>
							</c:if>
							<c:if
								test="${user.roleId ne '9d2a23cac05511e7aca65254002ec43c' }">
								<li><a class="J_menuItem" href="buyers/toBuyersList">买家信息列表</a>
								</li>
							</c:if>
							<li><a class="J_menuItem" href="coupon/toCouponList">优惠券列表</a>
							</li>
						</ul></li>
				</c:if>
				<c:if
					...
					<li><a class="J_menuItem"> <i class="fa fa-table"></i>
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="activityRegistration/toActivityRegistration">活动登记信息管理列表</a>
							</li>
				...
				<c:if test="${user.roleId ne '9d2a23cac05511e7aca65254002ec43c' }">
					<li><a class="J_menuItem"> <i class="fa fa-table"></i>
							信息发布 <span class="fa arrow"></span>
					</a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="news/toNewsList">新闻列表</a></li>
						</ul></li>
				</c:if>
				<li><a class="J_menuItem"> <i class="fa fa-table"></i> 数据统计
				...
				<div ng-if="${user!=null }"
					...
					<a style="text-align: center;" data-toggle="dropdown"
						class="dropdown-toggle" href="#"> <span class="clear">
							<span class="block m-t-xs"> <strong class="font-bold">欢迎你</strong>
						</span> <span style="margin-top: -20px;text-align:center;"
