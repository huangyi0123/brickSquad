...
<script type="text/javascript" src="resource/js/shopActivities_list.js"></script>
...
<script type="text/javascript">
	$(function() {
		var a = '${roleId}';
		console.log(123);
		console.log(${limiterole.shop_activities.dl});
		init("", ${limiterole.shop_activities.up}, ${limiterole.shop_activities.dl},
				${limiterole.shop_activities.query});
		serach();
...
<body>
	<div class="search">
		<div class="input-group" style="width: 520px;margin-left: 52px;">
			<input type="text" class="form-control" placeholder="可根据商品名称、店铺名称、活动类型等关键字搜索" id="keyword">
		...
		<c:if test="${user.roleId ne 'b0578c1cc05511e7aca65254002ec43c'}">
			<div class="input-group-btn" style="width:100px;">
				...
				<ul class="dropdown-menu">
					<li>
						<a href="shopActivities/toAddShopActivities?businessId=${business.id}"
