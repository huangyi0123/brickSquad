...
<script type="text/javascript"
	src="resource/js/memberShipApplication_list.js"></script>
<script type="text/javascript"
...
<body>
	<div class="search">
		<div class="input-group" style="width: 520px;margin-left: 52px;">
			<input type="text" class="form-control" placeholder="会员级别，申请人，审核人员" id="keyword">
	...
	<div class="input-group"
		...
		<div class="input-group-btn" style="width:100px;">
			...
			<ul class="dropdown-menu">
				<li><a href="memberShipApplication/toAddMemberShipApplication" 
