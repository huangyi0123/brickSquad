...
<script type="text/javascript"
	src="resource/js/activities_list.js"></script>
<script type="text/javascript"
  ...
  <body>
    <div class="search">
		<div class="input-group" style="width: 520px;margin-left: 52px;">
			<input type="text" id="keyword" class="form-control" placeholder="可输入活动名称、类型、负责人、内容进行查找" >
	...
	<div class="input-group"
		...
		<div class="input-group-btn" style="width:100px;">
			...
			<ul class="dropdown-menu">
				<li><a href="activities/toAddActivities" 
