...
<title>My JSP 'activitiesDetail.jsp' starting page</title>
...
<body class="container">
	<div class="page-header">
		...
		<h1 align="center">这里放活动名字</h1>
	</div>
	<div class="page-header">
		<h2 align="center">活动类型：活动类型  负责人：赵荣坤 </h2>
		<h2 align="center">开始时间：2017-12-5  结束时间：2017-12-25</h2>		
	</div>
		<div class="row">
		<h1>活动内容：</h1>
		<h3>贵大新闻网讯（见习记者 梁昱坤 摄影
		...
		<button type="button" class="btn btn-info btn-lg">我要报名</button>
</body>
</html>
