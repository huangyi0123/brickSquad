						...
						<div class="widget text-2 widget_text pull-left">
							<div class="widget-inner">
								<div class="textwidget">
									<div class="call-us">
										<span>拨打热线: </span>0123-444-666654123
									</div>
								</div>
							</div>
						</div>
					...
					<div id="main-menu" class="main-menu">
						...
						<div class="navbar-inner navbar-inverse">
							<div class="resmenu-container">
								...
								<div id="ResMenuprimary_menu"
									...
									<ul id="menu-primary-menu" class="etrostore_resmenu">
												...
												<li class="res-dropdown menu-home-pages"><a
													...
													<ul class="dropdown-resmenu">
														<li class="menu-home-page-1"><a
															href="home_page_1.html">首页 1</a></li>
										...
										<li class="active menu-deals"><a class="item-link"
										...
										<li class="menu-about-us"><a class="item-link"
											href="common/tpabout_us">关于我们</a></li>
							...
							<ul id="menu-primary-menu-1"
								...
								<li
									class="active menu-deals etrostore-menu-custom level1 etrostore-menu-img">
											...
											<div class="item-detail">
												<div class="item-img products-thumb">
													<span class="onsale">Sale!</span> <a
														...
														<div class="product-thumb-hover">
															<img width="300" height="300"
																src="resource/front_bootstrap/images/1903/26-300x300.jpg"
																class="attachment-shop_catalog size-shop_catalog wp-post-image"
																alt=""
											...
											<div class="item-detail">
												<div class="item-img products-thumb">
													<span class="onsale">Sale!</span> <a
														...
														<div class="product-thumb-hover">
															<img width="300" height="300"
																src="resource/front_bootstrap/images/1903/62-300x300.jpg"
																class="attachment-shop_catalog size-shop_catalog wp-post-image"
																alt=""
											...
											<div class="item-detail">
												<div class="item-img products-thumb">
													<span class="onsale">Sale!</span> <a
														...
														<div class="product-thumb-hover">
															<img width="300" height="300"
																src="resource/front_bootstrap/images/1903/50-300x300.jpg"
																class="attachment-shop_catalog size-shop_catalog wp-post-image"
																alt=""
