...
<head>
<base href="<%=basePath%>">
<title>Our Stores - Premium Multipurpose HTML5/CSS3 Theme</title>
<meta charset="utf-8" />
						...
						<div class="navbar-inner navbar-inverse">
								...
								<div id="ResMenuprimary_menu"
									...
									<ul id="menu-primary-menu" class="etrostore_resmenu">
										<li class="res-dropdown menu-home"><a
											class="item-link dropdown-toggle" href="home_page_1.html">Home</a>
							...
							<ul id="menu-primary-menu-1"
								...
								<li class="menu-about-us etrostore-menu-custom level1"><a
									href="about_us.html" class="item-link"> <span
										class="have-title"> <span class="menu-title">About
												Us</span>
									</span>
								</a></li>

								<li class="active menu-contact-us etrostore-menu-custom level1">
									<a href="contact_us.html" class="item-link"> <span
									...
									<div class="wpb_column vc_column_container vc_col-sm-12">
										<div class="vc_column-inner ">
											<div class="wpb_wrapper">
												<div
													class="wpb_raw_code wpb_content_element wpb_raw_html wrap-map2">
													<div class="wpb_wrapper">
														<div class="show-map">
																...
																<div class="row">
																	<div class="item col-lg3 col-md-3 col-sm-6">
																		<a href="#">
																			<div class="image">
																				<img
																					src="resource/front_bootstrap/images/1903/map1.jpg"
																					alt="map1" title="map1">
																				<h3>tokyo</h3>
																			</div>

																			<div class="des">No 1123, Marmora Road,
																	...
																	<div class="item col-lg3 col-md-3 col-sm-6">
																		<a href="#">
																			<div class="image">
																				<img
																					src="resource/front_bootstrap/images/1903/map2.jpg"
																					alt="map2" title="map2">
																				<h3>bejing</h3>
																			</div>
																	...
																	<div class="item col-lg3 col-md-3 col-sm-6">
																		<a href="#">
																			<div class="image">
																				<img
																					src="resource/front_bootstrap/images/1903/map3.jpg"
																					alt="map3" title="map3">
																				<h3>singapore</h3>
																			</div>
																	...
																	<div class="item col-lg3 col-md-3 col-sm-6">
																		<a href="#">
																			<div class="image">
																				<img
																					src="resource/front_bootstrap/images/1903/map4.jpg"
																					alt="map4" title="map4">
																				<h3>bangkok</h3>
																			</div>
