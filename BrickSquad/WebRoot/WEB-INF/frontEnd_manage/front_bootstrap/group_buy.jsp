...
<body class="page has-right-sidebar has-right-product-sidebar">
									...
									<div class="sw-hotdeal-content">
													...
													<div class="item-content">
														...
														<div class="reviews-content">
															<div class="star"></div>
															 ...
															 <div  class="item-number-rating" style="height: 20px ;"></div>
															<div class="item-number-rating">该商品<span style="color: red;">${a.buyersNumber}</span>人参团</div>
														</div>
														...
														<div class="item-price">
															...
															<ins>
																...
																<span class="woocommerce-Price-amount amount" style="color: red;">团购价</span>
																<span class="woocommerce-Price-currencySymbol">￥</span>${a.active_price }
																</span>
															</ins>
															</span>
														</div>
										...
										<div>
											...
											<ul class="pagination">
												...
												<li><a
													href="<%=pageUtil.getCurentPage()==1?"javascript:;":"group_buy/togroup_buy?curentPage="+(pageUtil.getCurentPage()-1)%>"
													style="<%=pageUtil.getCurentPage()==1?"color:#ccc":""%>"
												...
												<li><a
													...
													href="group_buy/togroup_buy?curentPage=<%=i%>"><%=i%></a></li>
												<%
													}
												%>
												<li><a
													href="<%=pageUtil.getCurentPage()==pageUtil.getPageCount()?"javascript:;":"group_buy/togroup_buy?curentPage="+(pageUtil.getCurentPage()+1)%>"
													style="<%=pageUtil.getCurentPage()==pageUtil.getPageCount()?"color:#ccc":""%>"
													aria-label="Next"> <span aria-hidden="true">&gt;</span>
												</a></li>
												<li><a
													href="<%=pageUtil.getCurentPage()==pageUtil.getPageCount()?"javascript:;":"group_buy/togroup_buy?curentPage="+pageUtil.getPageCount()%>"
													style="<%=pageUtil.getCurentPage()==pageUtil.getPageCount()?"color:#ccc":""%>">
	...
	<script type="text/javascript">
		function myChang(o, a) {
			...
			a = parseInt(a);
			if (n >= 1 && n <= a) {
				window.location.href = "group_buy/togroup_buy?curentPage=" + n;
			} else {
				$(o).val("");
			}
