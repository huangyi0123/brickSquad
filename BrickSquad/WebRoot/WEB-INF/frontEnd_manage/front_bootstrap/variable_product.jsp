					...
					<div class="breadcrumbs theme-clearfix">
						<div class="container">
							<ul class="breadcrumb">
								...
								<li><a href="shop_full_width.html">Cameras &amp;
										Accessories</a><span class="go-page"></span></li>
								<li><a href="shop_full_width.html">Batteries &amp;
										Chargers</a><span class="go-page"></span></li>
								<li class="active"><span>Variable Product</span></li>
							</ul>
						</div>
					</div>
				</div>
														...
														<div class="item-img-slider">
															<div class="images">
																<a href="resource/front_bootstrap/images/1903/54.jpg "
																	...
																	<img width="600" height="600" src="resource/front_bootstrap/images/1903/54.jpg"
														...
														<div class="item-img-slider">
															<div class="images">
																<a href="resource/front_bootstrap/images/1903/58.jpg "
																	data-rel="prettyPhoto[product-gallery]" class="zoom">
																	<img width="600" height="600" src="resource/front_bootstrap/images/1903/58.jpg"
																	class="attachment-shop_single size-shop_single" alt=""
														...
														<div class="item-img-slider">
															<div class="images">
																<a href="resource/front_bootstrap/images/1903/56.jpg "
																	data-rel="prettyPhoto[product-gallery]" class="zoom">
																	<img width="600" height="600" src="resource/front_bootstrap/images/1903/56.jpg"
																	class="attachment-shop_single size-shop_single" alt=""
														...
														<div class="item-img-slider">
															<div class="images">
																<a href="resource/front_bootstrap/images/1903/55.jpg "
																	data-rel="prettyPhoto[product-gallery]" class="zoom">
																	<img width="600" height="600" src="resource/front_bootstrap/images/1903/55.jpg"
																	class="attachment-shop_single size-shop_single" alt=""
								...
								<div class="tabbable">
									<ul class="nav nav-tabs">
										...
										<li class="reviews_tab "><a href="#tab-reviews"
											data-toggle="tab">Reviews (0)</a></li>
									</ul>
									...
									<div class=" tab-content">
										<div class="tab-pane active" id="tab-description">
											...
											<p>Proident adipisicing laborum beef ribs tri-tip dolore
												...
												tenderloin culpa excepteur. Fugiat irure est cupim dolor, ut
												nulla id andouille chicken spare ribs eiusmod brisket
												...
												prosciutto in sirloin fatback enim velit consectetur in pork
											...
											<p>Shank quis in duis, id officia nulla. Pancetta sunt
												...
												cupim proident turducken picanha. Sausage chicken incididunt
												ad occaecat porchetta pancetta corned beef ham hock laborum
												nisi ullamco pork loin kielbasa aliqua.</p>
											<p>In jerky minim chicken duis ground round nostrud pork
												...
												ham hock cupidatat laboris. Boudin spare ribs kevin meatloaf
												id short loin swine flank brisket aute. Reprehenderit turkey
												qui, boudin swine voluptate ipsum fugiat.</p>
