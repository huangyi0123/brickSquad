						...
						<c:if test="${user!=null }">
							<div class="sidebar-account pull-left">
								<div class="account-title">
									...
									<img style="display:block; border-radius:100%;width: 20px;height: 20px;margin-top: -5px;"
										alt="还没有图片" src="" id="indexUserPic">
									<span style="display: block;margin-left: 25px;margin-top: -15px;">${user.username }</span>
								</div>
										...
										<div class="widget-inner">
											<ul id="menu-my-account" class="menu">
												<li class="menu-my-account">
													<a class="item-link" href="common/toPersonal">
														<span class="menu-title">个人信息</span>
													</a>
												</li>

												<li class="menu-cart">
													<a class="item-link" href="javascript:;" onclick="logout()">
								...
								<div id="my-account" class="my-account">
									<div class="widget-1 widget-first widget nav_menu-4 widget_nav_menu">
										<div class="widget-inner">
											<ul id="menu-my-account" class="menu">
												<li class="menu-my-account">
													<a class="item-link" href="javascript:;" id="login">
														<span class="menu-title">登录</span>
													</a>
												</li>

												<li class="menu-cart">
													<a class="item-link" href="javascript:;" id="register">
