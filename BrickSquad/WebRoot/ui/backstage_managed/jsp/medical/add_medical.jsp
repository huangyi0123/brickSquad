...
<body>
	<form class="layui-form" action="medical/addMedical" id="form" method="get">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="Date" name="inspectionDate" required
					lay-verify="required" placeholder="检查日期" autocomplete="off"
					class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="typeId" required
					lay-verify="required" placeholder="检查类型" autocomplete="off"
					class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="hospital" required
					lay-verify="required" placeholder="检查医院" autocomplete="off"
					class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="content" required
					lay-verify="required" placeholder="病历详情" autocomplete="off"
					class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
