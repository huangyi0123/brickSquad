...
<script type="text/javascript"
	src="ui/backstage_managed/jsp/shoppingcar/shoppingcar_list.js"></script>
<script type="text/javascript"
	...
	<div class="input-group"
		...
		<div class="input-group-btn" style="width:100px;">
			...
			<ul class="dropdown-menu">
				<li><a href="${pageContext.request.contextPath}/shoppingCar/toAddShoppingCar" id="addShoppingCar"
