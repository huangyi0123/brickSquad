			...
			<div class="logo">
				<h1>
					<a href="ui/frontEnd_manage/index.jsp"><i><img
							src="images/cell.png" alt=" " /></i>Easy Recharge</a>
				</h1>
			</div>
			<div class="top-nav">
				<span class="menu"><img
								...
								<div class="tab-pane active" role="tabpanel" id="step1">
									<div class="mobile-grids">
										<div class="mobile-left text-center">
											<img src="ui/frontEnd_manage/images/mobile.png" alt="" />
										</div>
									...
									<div class="mobile-grids">
										...
										<div class="mobile-right ">
											...
											<div class="radio-btns">
												<div class="swit">
													<div class="check_box">
														<img src="ui/frontEnd_manage/images/card.png" alt="" />
														<div class="clearfix"></div>
														<div class="radio">
								...
								<div class="tab-pane" role="tabpanel" id="step4">
									<div class="mobile-grids">
										...
										<div class="mobile-right ">
											<h4>Which Circle?</h4>
											<div class="map-image">
												<img src="ui/frontEnd_manage/images/map.png" alt="" />
											</div>
											<div class="section_room">
												<select id="country" onchange="change_country(this.value)"
													class="frm-field required">
								...
								<div class="tab-pane" role="tabpanel" id="step5">
									<div class="mobile-grids">
										...
										<div class="mobile-right ">
											...
											<div class="mobile-rchge">
												<a href="ui/frontEnd_manage/single.html">VIEW PLANS</a>
											</div>
											<div class="clearfix"></div>
										</div>
									</div>
						...
						<form role="form">
							<div class="tab-content">
								<div class="tab-pane active" role="tabpanel" id="step6">
									<div class="mobile-grids">
										<div class="mobile-left text-center">
											<img src="ui/frontEnd_manage/images/dth.png" alt="" />
										</div>
										<div class="mobile-right ">
						...
						<form role="form">
							<div class="tab-content">
								<div class="tab-pane active" role="tabpanel" id="step9">
									<div class="mobile-grids">
										<div class="mobile-left text-center">
											<img src="ui/frontEnd_manage/images/usb.png" alt="" />
										</div>
										<div class="mobile-right ">
						...
						<form role="form">
							<div class="tab-content">
								<div class="tab-pane active" role="tabpanel" id="step12">
									<div class="mobile-grids">
										<div class="mobile-left text-center">
											<img src="ui/frontEnd_manage/images/landline.png" alt="" />
										</div>
										<div class="mobile-right">
